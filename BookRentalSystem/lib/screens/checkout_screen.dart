...
class _CheckoutScreenState extends State<CheckoutScreen> {
            ...
            LayoutBuilder(builder: (context, constraints) {
              if (constraints.maxWidth > 900) {
                return Row(
                  ...
                  children: [
                    Expanded(flex: 3, child: _buildFormSide(totalAmount)),
                    const SizedBox(width: 24),
                    Expanded(flex: 2, child: _buildSummarySide(totalRent, securityDeposit, totalAmount)),
                  ],
                );
              } else {
                return Column(
                  children: [
                    _buildFormSide(totalAmount),
                    const SizedBox(height: 24),
                    _buildSummarySide(totalRent, securityDeposit, totalAmount),
                  ],
                );
              }
            }),
  ...
  Widget _buildFormSide(double totalAmount) {
    return Container(
  ...
  Widget _buildSummarySide(double totalRent, double securityDeposit, double totalAmount) {
    return Column(
      children: [
        Container(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text('₹${totalAmount.toInt()}', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: darkGreen)),
                ],
              ),
            ],
          ),
